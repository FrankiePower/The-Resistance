...
import { TheResistanceGame } from './games/the-resistance/TheResistanceGame';

const GAME_ID = 'the-resistance';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'The Resistance';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_THE_RESISTANCE_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
